# Target hypothesis card: KIT

## Target identity

- **Target symbol:** KIT
- **Target name:** KIT proto-oncogene, receptor tyrosine kinase
- **Open Targets melanoma score:** 0.718
- **Open Targets baseline rank:** 13
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 21 | not prioritized | -8 |
| Resistance biomarker | 0.098 | 22 | not prioritized | -9 |
| Tumor-intrinsic / small molecule | 0.679 | 5 | medium | 8 |
