# Target hypothesis card: MRTFA

## Target identity

- **Target symbol:** MRTFA
- **Target name:** myocardin related transcription factor A
- **Open Targets melanoma score:** 0.509
- **Open Targets baseline rank:** 242
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 244 | not prioritized | -2 |
| Resistance biomarker | 0.000 | 244 | not prioritized | -2 |
| Tumor-intrinsic / small molecule | 0.000 | 244 | not prioritized | -2 |
