# Target hypothesis card: PDGFRA

## Target identity

- **Target symbol:** PDGFRA
- **Target name:** platelet derived growth factor receptor alpha
- **Open Targets melanoma score:** 0.666
- **Open Targets baseline rank:** 27
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 34 | not prioritized | -7 |
| Resistance biomarker | 0.000 | 36 | not prioritized | -9 |
| Tumor-intrinsic / small molecule | 0.004 | 29 | not prioritized | -2 |
