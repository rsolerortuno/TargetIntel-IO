# Target hypothesis card: MYCN

## Target identity

- **Target symbol:** MYCN
- **Target name:** MYCN proto-oncogene, bHLH transcription factor
- **Open Targets melanoma score:** 0.556
- **Open Targets baseline rank:** 143
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 145 | not prioritized | -2 |
| Resistance biomarker | 0.000 | 146 | not prioritized | -3 |
| Tumor-intrinsic / small molecule | 0.000 | 145 | not prioritized | -2 |
