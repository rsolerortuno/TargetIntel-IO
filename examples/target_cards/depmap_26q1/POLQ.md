# Target hypothesis card: POLQ

## Target identity

- **Target symbol:** POLQ
- **Target name:** DNA polymerase theta
- **Open Targets melanoma score:** 0.598
- **Open Targets baseline rank:** 71
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 75 | not prioritized | -4 |
| Resistance biomarker | 0.000 | 77 | not prioritized | -6 |
| Tumor-intrinsic / small molecule | 0.000 | 75 | not prioritized | -4 |
