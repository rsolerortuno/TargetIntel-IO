# Target hypothesis card: ARNT

## Target identity

- **Target symbol:** ARNT
- **Target name:** aryl hydrocarbon receptor nuclear translocator
- **Open Targets melanoma score:** 0.560
- **Open Targets baseline rank:** 134
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 136 | not prioritized | -2 |
| Resistance biomarker | 0.000 | 137 | not prioritized | -3 |
| Tumor-intrinsic / small molecule | 0.000 | 136 | not prioritized | -2 |
