# Target hypothesis card: PHOX2B

## Target identity

- **Target symbol:** PHOX2B
- **Target name:** paired like homeobox 2B
- **Open Targets melanoma score:** 0.568
- **Open Targets baseline rank:** 122
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 124 | not prioritized | -2 |
| Resistance biomarker | 0.000 | 125 | not prioritized | -3 |
| Tumor-intrinsic / small molecule | 0.000 | 124 | not prioritized | -2 |
