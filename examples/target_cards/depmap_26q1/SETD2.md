# Target hypothesis card: SETD2

## Target identity

- **Target symbol:** SETD2
- **Target name:** SET domain containing 2, histone lysine methyltransferase
- **Open Targets melanoma score:** 0.635
- **Open Targets baseline rank:** 38
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 45 | not prioritized | -7 |
| Resistance biomarker | 0.000 | 47 | not prioritized | -9 |
| Tumor-intrinsic / small molecule | 0.000 | 45 | not prioritized | -7 |
