# Target hypothesis card: PTPRB

## Target identity

- **Target symbol:** PTPRB
- **Target name:** protein tyrosine phosphatase receptor type B
- **Open Targets melanoma score:** 0.592
- **Open Targets baseline rank:** 82
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 85 | not prioritized | -3 |
| Resistance biomarker | 0.000 | 87 | not prioritized | -5 |
| Tumor-intrinsic / small molecule | 0.000 | 85 | not prioritized | -3 |
