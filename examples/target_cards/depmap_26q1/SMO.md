# Target hypothesis card: SMO

## Target identity

- **Target symbol:** SMO
- **Target name:** smoothened, frizzled class receptor
- **Open Targets melanoma score:** 0.518
- **Open Targets baseline rank:** 221
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 223 | not prioritized | -2 |
| Resistance biomarker | 0.000 | 223 | not prioritized | -2 |
| Tumor-intrinsic / small molecule | 0.000 | 223 | not prioritized | -2 |
