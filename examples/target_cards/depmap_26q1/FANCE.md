# Target hypothesis card: FANCE

## Target identity

- **Target symbol:** FANCE
- **Target name:** FA complementation group E
- **Open Targets melanoma score:** 0.495
- **Open Targets baseline rank:** 258
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 260 | not prioritized | -2 |
| Resistance biomarker | 0.000 | 260 | not prioritized | -2 |
| Tumor-intrinsic / small molecule | 0.000 | 260 | not prioritized | -2 |
