# Target hypothesis card: WRN

## Target identity

- **Target symbol:** WRN
- **Target name:** WRN RecQ like helicase
- **Open Targets melanoma score:** 0.610
- **Open Targets baseline rank:** 57
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 61 | not prioritized | -4 |
| Resistance biomarker | 0.000 | 63 | not prioritized | -6 |
| Tumor-intrinsic / small molecule | 0.000 | 61 | not prioritized | -4 |
