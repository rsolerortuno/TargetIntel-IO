# Target hypothesis card: FAS

## Target identity

- **Target symbol:** FAS
- **Target name:** Fas cell surface death receptor
- **Open Targets melanoma score:** 0.520
- **Open Targets baseline rank:** 214
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 216 | not prioritized | -2 |
| Resistance biomarker | 0.000 | 216 | not prioritized | -2 |
| Tumor-intrinsic / small molecule | 0.000 | 216 | not prioritized | -2 |
