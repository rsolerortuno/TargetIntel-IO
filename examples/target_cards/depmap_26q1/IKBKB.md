# Target hypothesis card: IKBKB

## Target identity

- **Target symbol:** IKBKB
- **Target name:** inhibitor of nuclear factor kappa B kinase subunit beta
- **Open Targets melanoma score:** 0.575
- **Open Targets baseline rank:** 108
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 111 | not prioritized | -3 |
| Resistance biomarker | 0.000 | 112 | not prioritized | -4 |
| Tumor-intrinsic / small molecule | 0.000 | 111 | not prioritized | -3 |
