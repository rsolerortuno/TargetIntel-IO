# Target hypothesis card: CBLB

## Target identity

- **Target symbol:** CBLB
- **Target name:** Cbl proto-oncogene B
- **Open Targets melanoma score:** 0.558
- **Open Targets baseline rank:** 139
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 141 | not prioritized | -2 |
| Resistance biomarker | 0.000 | 142 | not prioritized | -3 |
| Tumor-intrinsic / small molecule | 0.000 | 141 | not prioritized | -2 |
