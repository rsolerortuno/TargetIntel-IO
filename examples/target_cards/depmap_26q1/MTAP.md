# Target hypothesis card: MTAP

## Target identity

- **Target symbol:** MTAP
- **Target name:** methylthioadenosine phosphorylase
- **Open Targets melanoma score:** 0.522
- **Open Targets baseline rank:** 206
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 208 | not prioritized | -2 |
| Resistance biomarker | 0.000 | 208 | not prioritized | -2 |
| Tumor-intrinsic / small molecule | 0.000 | 208 | not prioritized | -2 |
