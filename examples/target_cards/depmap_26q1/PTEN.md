# Target hypothesis card: PTEN

## Target identity

- **Target symbol:** PTEN
- **Target name:** phosphatase and tensin homolog
- **Open Targets melanoma score:** 0.765
- **Open Targets baseline rank:** 7
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 15 | not prioritized | -8 |
| Resistance biomarker | 0.313 | 16 | low | -9 |
| Tumor-intrinsic / small molecule | 0.000 | 38 | not prioritized | -31 |
