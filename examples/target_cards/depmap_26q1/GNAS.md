# Target hypothesis card: GNAS

## Target identity

- **Target symbol:** GNAS
- **Target name:** GNAS complex locus
- **Open Targets melanoma score:** 0.569
- **Open Targets baseline rank:** 116
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 118 | not prioritized | -2 |
| Resistance biomarker | 0.000 | 119 | not prioritized | -3 |
| Tumor-intrinsic / small molecule | 0.000 | 118 | not prioritized | -2 |
