# Target hypothesis card: HRAS

## Target identity

- **Target symbol:** HRAS
- **Target name:** HRas proto-oncogene, GTPase
- **Open Targets melanoma score:** 0.470
- **Open Targets baseline rank:** 283
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 283 | not prioritized | 0 |
| Resistance biomarker | 0.000 | 283 | not prioritized | 0 |
| Tumor-intrinsic / small molecule | 0.000 | 283 | not prioritized | 0 |
