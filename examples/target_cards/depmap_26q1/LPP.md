# Target hypothesis card: LPP

## Target identity

- **Target symbol:** LPP
- **Target name:** LIM domain containing preferred translocation partner in lipoma
- **Open Targets melanoma score:** 0.478
- **Open Targets baseline rank:** 276
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 276 | not prioritized | 0 |
| Resistance biomarker | 0.000 | 276 | not prioritized | 0 |
| Tumor-intrinsic / small molecule | 0.000 | 276 | not prioritized | 0 |
