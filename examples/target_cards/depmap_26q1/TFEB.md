# Target hypothesis card: TFEB

## Target identity

- **Target symbol:** TFEB
- **Target name:** transcription factor EB
- **Open Targets melanoma score:** 0.531
- **Open Targets baseline rank:** 186
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 188 | not prioritized | -2 |
| Resistance biomarker | 0.000 | 189 | not prioritized | -3 |
| Tumor-intrinsic / small molecule | 0.000 | 188 | not prioritized | -2 |
