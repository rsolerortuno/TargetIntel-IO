# Target hypothesis card: MAX

## Target identity

- **Target symbol:** MAX
- **Target name:** MYC associated transcriptional regulator X
- **Open Targets melanoma score:** 0.519
- **Open Targets baseline rank:** 215
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 217 | not prioritized | -2 |
| Resistance biomarker | 0.000 | 217 | not prioritized | -2 |
| Tumor-intrinsic / small molecule | 0.000 | 217 | not prioritized | -2 |
