# Target hypothesis card: STAT5B

## Target identity

- **Target symbol:** STAT5B
- **Target name:** signal transducer and activator of transcription 5B
- **Open Targets melanoma score:** 0.496
- **Open Targets baseline rank:** 255
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 257 | not prioritized | -2 |
| Resistance biomarker | 0.000 | 257 | not prioritized | -2 |
| Tumor-intrinsic / small molecule | 0.000 | 257 | not prioritized | -2 |
