# Target hypothesis card: MECOM

## Target identity

- **Target symbol:** MECOM
- **Target name:** MDS1 and EVI1 complex locus
- **Open Targets melanoma score:** 0.611
- **Open Targets baseline rank:** 56
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 60 | not prioritized | -4 |
| Resistance biomarker | 0.000 | 62 | not prioritized | -6 |
| Tumor-intrinsic / small molecule | 0.000 | 60 | not prioritized | -4 |
