# Target hypothesis card: PTPRK

## Target identity

- **Target symbol:** PTPRK
- **Target name:** protein tyrosine phosphatase receptor type K
- **Open Targets melanoma score:** 0.582
- **Open Targets baseline rank:** 95
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 98 | not prioritized | -3 |
| Resistance biomarker | 0.000 | 99 | not prioritized | -4 |
| Tumor-intrinsic / small molecule | 0.000 | 98 | not prioritized | -3 |
