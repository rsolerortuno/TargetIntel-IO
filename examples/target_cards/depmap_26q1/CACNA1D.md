# Target hypothesis card: CACNA1D

## Target identity

- **Target symbol:** CACNA1D
- **Target name:** calcium voltage-gated channel subunit alpha1 D
- **Open Targets melanoma score:** 0.517
- **Open Targets baseline rank:** 224
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 226 | not prioritized | -2 |
| Resistance biomarker | 0.000 | 226 | not prioritized | -2 |
| Tumor-intrinsic / small molecule | 0.000 | 226 | not prioritized | -2 |
