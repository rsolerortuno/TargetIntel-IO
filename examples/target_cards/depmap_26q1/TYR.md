# Target hypothesis card: TYR

## Target identity

- **Target symbol:** TYR
- **Target name:** tyrosinase
- **Open Targets melanoma score:** 0.585
- **Open Targets baseline rank:** 92
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 95 | not prioritized | -3 |
| Resistance biomarker | 0.000 | 97 | not prioritized | -5 |
| Tumor-intrinsic / small molecule | 0.000 | 95 | not prioritized | -3 |
