# Target hypothesis card: ALK

## Target identity

- **Target symbol:** ALK
- **Target name:** ALK receptor tyrosine kinase
- **Open Targets melanoma score:** 0.492
- **Open Targets baseline rank:** 261
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 263 | not prioritized | -2 |
| Resistance biomarker | 0.000 | 263 | not prioritized | -2 |
| Tumor-intrinsic / small molecule | 0.000 | 263 | not prioritized | -2 |
