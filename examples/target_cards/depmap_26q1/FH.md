# Target hypothesis card: FH

## Target identity

- **Target symbol:** FH
- **Target name:** fumarate hydratase
- **Open Targets melanoma score:** 0.507
- **Open Targets baseline rank:** 246
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 248 | not prioritized | -2 |
| Resistance biomarker | 0.000 | 248 | not prioritized | -2 |
| Tumor-intrinsic / small molecule | 0.000 | 248 | not prioritized | -2 |
