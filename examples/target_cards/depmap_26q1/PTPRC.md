# Target hypothesis card: PTPRC

## Target identity

- **Target symbol:** PTPRC
- **Target name:** protein tyrosine phosphatase receptor type C
- **Open Targets melanoma score:** 0.550
- **Open Targets baseline rank:** 158
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 160 | not prioritized | -2 |
| Resistance biomarker | 0.000 | 161 | not prioritized | -3 |
| Tumor-intrinsic / small molecule | 0.000 | 160 | not prioritized | -2 |
