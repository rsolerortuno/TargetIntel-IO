# Target hypothesis card: NFKBIE

## Target identity

- **Target symbol:** NFKBIE
- **Target name:** NFKB inhibitor epsilon
- **Open Targets melanoma score:** 0.552
- **Open Targets baseline rank:** 151
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 153 | not prioritized | -2 |
| Resistance biomarker | 0.000 | 154 | not prioritized | -3 |
| Tumor-intrinsic / small molecule | 0.000 | 153 | not prioritized | -2 |
