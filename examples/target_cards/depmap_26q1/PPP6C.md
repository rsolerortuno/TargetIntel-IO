# Target hypothesis card: PPP6C

## Target identity

- **Target symbol:** PPP6C
- **Target name:** protein phosphatase 6 catalytic subunit
- **Open Targets melanoma score:** 0.696
- **Open Targets baseline rank:** 22
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 29 | not prioritized | -7 |
| Resistance biomarker | 0.000 | 31 | not prioritized | -9 |
| Tumor-intrinsic / small molecule | 0.010 | 24 | not prioritized | -2 |
