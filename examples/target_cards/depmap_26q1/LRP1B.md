# Target hypothesis card: LRP1B

## Target identity

- **Target symbol:** LRP1B
- **Target name:** LDL receptor related protein 1B
- **Open Targets melanoma score:** 0.658
- **Open Targets baseline rank:** 29
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 36 | not prioritized | -7 |
| Resistance biomarker | 0.000 | 38 | not prioritized | -9 |
| Tumor-intrinsic / small molecule | 0.002 | 31 | not prioritized | -2 |
