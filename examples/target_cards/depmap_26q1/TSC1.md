# Target hypothesis card: TSC1

## Target identity

- **Target symbol:** TSC1
- **Target name:** TSC complex subunit 1
- **Open Targets melanoma score:** 0.588
- **Open Targets baseline rank:** 86
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 89 | not prioritized | -3 |
| Resistance biomarker | 0.000 | 91 | not prioritized | -5 |
| Tumor-intrinsic / small molecule | 0.000 | 89 | not prioritized | -3 |
