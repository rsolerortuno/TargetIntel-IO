# Target hypothesis card: BCOR

## Target identity

- **Target symbol:** BCOR
- **Target name:** BCL6 corepressor
- **Open Targets melanoma score:** 0.552
- **Open Targets baseline rank:** 154
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 156 | not prioritized | -2 |
| Resistance biomarker | 0.000 | 157 | not prioritized | -3 |
| Tumor-intrinsic / small molecule | 0.000 | 156 | not prioritized | -2 |
