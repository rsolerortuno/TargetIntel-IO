# Target hypothesis card: SUFU

## Target identity

- **Target symbol:** SUFU
- **Target name:** SUFU negative regulator of hedgehog signaling
- **Open Targets melanoma score:** 0.543
- **Open Targets baseline rank:** 175
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 177 | not prioritized | -2 |
| Resistance biomarker | 0.000 | 178 | not prioritized | -3 |
| Tumor-intrinsic / small molecule | 0.000 | 177 | not prioritized | -2 |
