# Target hypothesis card: DAXX

## Target identity

- **Target symbol:** DAXX
- **Target name:** death domain associated protein
- **Open Targets melanoma score:** 0.550
- **Open Targets baseline rank:** 157
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 159 | not prioritized | -2 |
| Resistance biomarker | 0.000 | 160 | not prioritized | -3 |
| Tumor-intrinsic / small molecule | 0.000 | 159 | not prioritized | -2 |
