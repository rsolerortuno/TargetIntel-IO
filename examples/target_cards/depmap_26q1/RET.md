# Target hypothesis card: RET

## Target identity

- **Target symbol:** RET
- **Target name:** ret proto-oncogene
- **Open Targets melanoma score:** 0.537
- **Open Targets baseline rank:** 182
...
| --- | ---: | ---: | --- | ---: |
| Antibody / IO-combination | 0.000 | 184 | not prioritized | -2 |
| Resistance biomarker | 0.000 | 185 | not prioritized | -3 |
| Tumor-intrinsic / small molecule | 0.000 | 184 | not prioritized | -2 |
